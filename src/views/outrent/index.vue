...
<!--         <van-col span="5" @click="changeType('outrent')">出租</van-col>-->
         <van-col span="5" class="active-font-weight"><span class="pr"><span class="kailong-up kuicon"></span></span>出租</van-col>
...
<!--                             &lt;!&ndash;                        <img class="" :src="item.url" height="140px" width="100%" />&ndash;&gt;-->
<!--                           </van-col>-->
<!--                           <van-col span="15">-->
<!--                             <div class="ml10 " style="font-weight: bolder">-->
<!--                               <div class="van-ellipsis fb c13 f16 mt5 ">{{item.title}}</div>-->
...
<script>
  ...
  import Vue from 'vue'
  import {Toast,Tab, Tabs ,Image as VanImage ,Tag,Divider,Lazyload, Tabbar, TabbarItem,Search,DropdownMenu, DropdownItem,Popup,Checkbox, CheckboxGroup } from 'vant';
