...
<!--                  <el-option label="酒店宾馆" value="酒店宾馆"/><el-option label="其他" value="其他"/>-->
          ...
          <div class="info_form">
            <div class="info_form" >
              <p class="mt10 ">按月租金：&nbsp;&nbsp; <el-input v-model=" dataForm.monthlyRent " style="width: 160px" placeholder="请输入商铺总价" type="number"/> 元/月</p>
              ...
              <p class="mt10" v-if="dataForm.type===3">
          ...
          <div class="info_form"  >
            <van-row>
              ...
              <van-col span="18">
                <el-input v-model=" dataForm.about " :rows="6" type="textarea" placeholder="请输入详细介绍" style="width:100%"/>
              </van-col>
            </van-row>
          </div>
...
<script>
  ...
  import {getAreaListcityname,getListByclassificationId,getRentoutInfoById,uploadFileImg,getAreaList,getclientInfo, saverentout, saveSell } from '@/api/rentout'
  export default {
    name: 'publish',
    data() {
      return {
    ...
    created() {
     this.token= localStorage.getItem('token')
      // alert( this.token)
      this.show=true;
      this.rentoutId = this.$route.query.rentoutId
      if (this.rentoutId) {
    ...
    methods: {
      ...
      validateRFun() {
        ...
        if (_this.dataForm.type === '' || !_this.dataForm.type) {
